...
class DiffusivityStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Diffusivity step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return diffusivity_step.Diffusivity(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return diffusivity_step.TkDiffusivity(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return DiffusivityStep.my_description
